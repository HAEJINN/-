package com.ecommerce.domain.purchase.api;

import com.ecommerce.domain.purchase.application.EscrowContractService;
import com.ecommerce.domain.purchase.application.PurchaseRecordContractService;
import com.ecommerce.domain.purchase.application.PurchaseService;
...
import com.ecommerce.domain.item.api.ItemController;
...
public class PurchaseController {
    ...
    private PurchaseRecordContractService purchaseRecordContractService;
    private EscrowContractService escrowContractService;

    public PurchaseController(final PurchaseService purchaseService,
                              final PurchaseRecordContractService purchaseRecordContractService,
                              final EscrowContractService escrowContractService) {
