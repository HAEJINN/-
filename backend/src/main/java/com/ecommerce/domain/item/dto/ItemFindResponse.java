...
public class ItemFindResponse {
    ...
    public static ItemFindResponse ofItem(final Item item) {
        ...
        return new ItemFindResponse(id, name, category, explanation, available, seller, registeredAt, image);
    }

    public ItemFindResponse(final Long id, final String name, final String category, final String explanation,
