...
public class ItemFindSellerListResponse {
    private Long id;
    private String name;
    ...
    public static ItemFindSellerListResponse ofItem(final Item item) {
        ...
        return new ItemFindSellerListResponse(id, name, category, explanation, available, seller, registeredAt, image);
    }

    public ItemFindSellerListResponse(final Long id, final String name, final String category, final String explanation,
