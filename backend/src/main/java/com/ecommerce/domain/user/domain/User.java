...
public class User extends BaseTimeEntity {
    ...
    @Builder
    public User(final String email, final String name, final String password, final String profileImage, final Wallet wallet, final Set<Follow> myFollowing, final Set<Follow> myFollower) {
        this.email = email;
        this.name = name;
    ...
    public User changePhoto(final String profileImage) {
